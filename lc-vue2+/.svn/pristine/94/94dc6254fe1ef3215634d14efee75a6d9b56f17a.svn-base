<template lang="html">
    <div id="orderDetailComp" ref="scroll">
        <div class="scroll" >
            <header-common :title="viewTitle" :iconType="iconType" :rightParams="rightParams" :paths="close" v-on:closeOrderDetail="closeOrderDetailReal"></header-common>
            <div style="height:45px"></div>
            <div class="orderDetailWrap scrollBar" >
                    <div class="txtInfo">
...
export default {
    ...
    methods: {
        closeOrderDetailReal () {
            this.$emit('closeOrderDetailInParent')
