...
export default {
    ...
    created () {
        ...
        var coodieUserName = window.localStorage.loginUserName
        var coodiePassword = window.localStorage.loginPassword
        if (coodieUserName) {
    ...
    methods: {
                ...
                if (res.data.success === true) {
                    if (res.data.data.loginSuccess === false) {
                        ...
                        if (this.isSavePassword) {
                            ...
                            // window.localStorage.removeItem('userToken')
                            window.localStorage.loginPassword = this.password
                        } else {
                        ...
                        if (this.isSaveAccount) {
                            ...
                            window.localStorage.loginUserName = this.userName
                        } else {
        ...
        // 注册设备码
        registerSBM () {
            // window.alert(window.sessionStorage.jgCode)
            var code = window.sessionStorage.jgCode?window.sessionStorage.jgCode:''
