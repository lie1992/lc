(function(a) {
    ...
    };    a.PageDialog.confirmZDY = function(g, c, b, tx) {        var e = null;        var d = '<div class="clearfix m-round u-tipsEject"><div class="u-tips-txt">' + g + '</div><div class="u-Btn"><div class="u-Btn-li"><a href="javascript:;" id="btnMsgCancel" class="z-CloseBtn">取消</a></div><div class="u-Btn-li"><a id="btnMsgOK" href="javascript:;" class="z-DefineBtn cpCls">'+tx+'</a></div></div></div>';        var f = function() {            a("#btnMsgCancel").click(function() {                e.cancel()            });            a("#btnMsgOK").click(function() {                e.close()            })        };        e = new a.PageDialog(d, {            H: (b === undefined ? 126 : b),            autoClose: false,            ready: f,            submit: c        })    }
})(jQuery);
