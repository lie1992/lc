...
export default {
    ...
    created () {
        // console.log(this.$store.state.posi.cartPosi)
        // window.scroll(0,this.$store.state.posi.cartPosi)
    ...
    watch: {
        cartData () {
            ...
            if (this.$store.state.cart.cartSelData) {
    ...
    methods: {
        ...
        getCartData () {
            ...
            if (sid) {
                ...
                var params = '?customerCarId=' + this.defaultCar.id
                this.getData(params)
            }
        },
        getData (params) {
