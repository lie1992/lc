    ...
    <div class="sprinkle serveCommon">
        <div class="serveIndexWrap serveCommonWrap">
            <div class="searchWrap">
                <!-- <div class="searchMask"><label></label>搜索</div> -->
...
export default {
    ...
    methods: {
        ...
        getData (type) {
            ajax.ajax({
                ...
                'statusOk': function (res, v) {
                    v.serveData = res.data.data
                    v.$nextTick(function() {
                        if(window.localStorage.serveScrollY){
                            document.body.scrollTop = window.localStorage.serveScrollY
                            window.localStorage.serveScrollY = 0
                        }
                    })
                },
                'statusError': function (res, v) {
        ...
        // 服务介绍
        onExp (id) {
            window.localStorage.serveScrollY = document.body.scrollTop
